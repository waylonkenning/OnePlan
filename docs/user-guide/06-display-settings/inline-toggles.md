...
- Cycles through three states: off → label mode → bar-height mode → off.
...
Previous: [Grouping Modes](grouping-modes.md) | Next: [Zoom and Column Width](zoom-and-columns.md)
