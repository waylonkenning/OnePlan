...
- Apply any grouping or display settings that reflect the view you want to share.
- Both export formats capture the visible canvas; scroll position and zoom level affect what is included.

---

- Previous: [Excel Export](excel-export.md)
- Next: [Card View](../12-mobile/card-view.md)
